            ...
            markers: [
                {
                    ...
                    content: 
                        '<h1>CAJAS</h1><p>Éstas figuran la acción del abandono que lleva a cabo la protagonista cuando monta el mercadillo de antigüedades en el jardín. Llenas de objetos que pertenecen a la casa, las cajas están presentes en distintas escenas; simbolizando la presión que sufre Ada para aceptar la realidad y pasar página. <br/><br/>En el cortometraje encontraremos las cajas en el comedor, la habitación de Ada y el mercadillo.<br/></p>'
                },
                {
                    id: 'poster',
                    polygon_px: [
                    ...
                    content: 
                        '<h1>PÓSTER</h1><p>Ada va coleccionando los números de las revistas <i>OASIS</i> y con ellas los fragmentos de póster que llegan con cada entrega. Así compone el gran póster de <i>OASIS</i> con el mensaje: <i>“Completa tu OASIS”</i>. Éste representa el trayecto que hace la protagonista durante la colección esperando que le aporte un estado de felicidad para reemplazar su vacío inconsciente. Una vez completado, apreciará que este universo la está alejando de la realidad. <br/><br/> En el cortometraje encontraremos el póster en la habitación.<br/></p>'
                },     
                {
                    id: 'posits',
                    polygon_px: [
            ...
            return(
                <div>
                    <div >
                        ...
                        <fieldset style={{zIndex:2, heigh:'70vh', marginBottom:'30vh'}}/>
